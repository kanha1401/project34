...
function setup() {
  ...
  box12= new Box(900, 100, 60, 60);
  box13= new Box(900, 100, 60, 60);
  box14= new Box(750,100,60,60);
  box15= new Box(750,100,60,60);
  box16= new Box(750,100,60,60);
  box17= new Box(750,100,60,60);
  box18= new Box(750,100,60,60);
  box19= new Box(750,100,60,60);
